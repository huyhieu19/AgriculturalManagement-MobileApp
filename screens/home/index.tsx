...
export default function HomeScreen() {
    return (
        <Tab.Navigator
            ...
            <Tab.Screen options={{
                tabBarIcon: ({focused}) => <Feather name="home" size={27} color={getFocusColor(focused)}/>
            }} name="Home" component={HomeTab}/>
            <Tab.Screen options={{
                tabBarIcon: ({focused}) => <MaterialCommunityIcons name="weather-partly-snowy-rainy" size={27}
                                                                   color={getFocusColor((focused))}/>,
            }} name="Weather" component={WeatherTab}/>
            <Tab.Screen options={{
                tabBarIcon: ({focused}) => <AntDesign name="profile" size={27} color={getFocusColor((focused))}/>
