  ...
  return (
    <SafeAreaView style={[AppStyles.appContainer]}>
      ...
      >
        ...
        <Text style={{ fontSize: 18, color: "white" }}>Thông tin cá nhân</Text>
      ...
      <ScrollView>
        ...
        <View style={{ marginTop: 50, paddingHorizontal: 20 }}>
          ...
          >
            ...
            <View style={styles.cardItem}>
              <Image style={styles.imageIcon} source={smartphoneIcon} />
              <Text style={{ fontSize: 16 }}>{user.phoneNumber}</Text>
            </View>
            <View style={styles.cardItem}>
              <Image style={styles.imageIcon} source={gmailIcon} />
