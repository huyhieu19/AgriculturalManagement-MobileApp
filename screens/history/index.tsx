...
import { LogDeviceDataQueryModel, LogDeviceStatusEntity, TypeOnOff } from "../../network/models/log_display/LogDevice";
...
const LogDeviceControlScreen = () => {
    ...
    const [typeOnOff, setTypeOnOff] = useState<TypeOnOff>(1);
